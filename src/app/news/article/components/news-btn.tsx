  ...
  return (
    <div className="w-fit flex flex-col sm:flex-row gap-4 _912cfm">
      <button
        ...
        className="text-light text-sm font-medium px-4 py-2.5 rounded-sm bg-red"
      >
      ...
      <button
        ...
        className={`text-red text-sm font-semibold px-4 py-2.5 border-2 border-red rounded-sm ${
          view ? "" : "hidden"
        }`}
      >
        <span className="sr-only">
