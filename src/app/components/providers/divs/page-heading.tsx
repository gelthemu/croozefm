...
const H2Title: React.FC<H2TitleProps> = ({ title }) => {
  return (
    <h2 className="w-fit text-2xl text-red _912cfm mb-4 pb-1.5 relative after:absolute after:bottom-0 after:left-0 after:w-2/5 after:border-b-[3px] after:border-red">
      {title}
    </h2>
  );
};
