                  ...
                  <div className="p-3 bg-gray/10 dark:bg-light/5">
                    <div className="w-full flex justify-end">
                      <div
                        ...
                        className="bg-[#3eac75] text-light font-medium _912cfm px-4 py-2 rounded-md focus:outline-none"
                      >
                  ...
                  <div className="p-3 bg-gray/10 dark:bg-light/5">
                    <div className="w-full flex justify-end">
                      <div
                        ...
                        className="bg-red text-light font-medium _912cfm px-4 py-2 rounded-md focus:outline-none"
                      >
                        {`Join Chat`}
                      </div>
                    </div>
