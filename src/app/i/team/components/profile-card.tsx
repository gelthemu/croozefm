...
const PresenterCard: React.FC<PresenterCardProps> = ({ profile }) => {
  ...
  return (
    <>
      <div className="group flex flex-col rounded-sm overflow-hidden flex-shrink-0 border-2 border-dark/40 dark:border-light/30">
        <Link href={`/i/${profile.id}`} className="relative">
          <div className="h-80 w-full overflow-hidden">
            <Image
              ...
              height={2784}
              priority={true}
              className="w-full object-center-top aspect-[570/696] group-hover:scale-100 transition-transform duration-300 _img_"
            />
          </div>
